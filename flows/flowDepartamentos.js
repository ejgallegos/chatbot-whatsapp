...
const flowFechaReserva = addKeyword('')
...
const flowDepartamentos = addKeyword(['Una', 'Dos'])
    ...
    .addAnswer('Elige alguna de las opciones que te mostré.', {
        buttons: [{ body: 'Loft Centro' }, { body: 'Depto. del Talampaya' }]
    })
    .addAction((ctx) => {
...
module.exports = { flowDepartamentos, flowFechaReserva, flowNombreApellido, flowInfoReserva };